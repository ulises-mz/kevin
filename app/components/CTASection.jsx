...
export default function CTASection() {
  ...
  const handlePhoneClick = () => {
    window.location.href = 'tel:+50689417464';
  };

  const handleEmailClick = () => {
    window.location.href = 'mailto:olmanlr2238@gmail.com';
  };
        ...
        <ScrollReveal>
          <div className={styles.content}>
            ...
            <p className={styles.subtitle}>
              Cotice sin compromiso. Respuesta en menos de 24 horas.
            </p>
            ...
            <div className={styles.contactMethods}>
              ...
              >
                ...
                <div>
                  <div className={styles.buttonLabel}>WhatsApp</div>
                  <div className={styles.buttonValue}>8941-7464</div>
                </div>
              ...
              >
                ...
                <div>
                  <div className={styles.buttonLabel}>Llamar</div>
                  <div className={styles.buttonValue}>8941-7464</div>
                </div>
                <div className={styles.buttonGlow}></div>
              </motion.button>
              ...
              >
                ...
                <div>
                  ...
                  <div className={styles.buttonValue}>olmanlr2238@gmail.com</div>
                </div>
                <div className={styles.buttonGlow}></div>
              </motion.button>
            </div>
